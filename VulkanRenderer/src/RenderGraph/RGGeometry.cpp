...
namespace RG
{
    void Geometry::ApplyRenderObjectPermutation(const ModelCollection::RenderObjectPermutation& permutation,
    ...
    Geometry::AttributeBuffers Geometry::InitAttributeBuffers(const CountsInfo& countsInfo)
    {
    ...
    void Geometry::InitBuffers(Geometry& renderPassGeometry, const CountsInfo& countsInfo)
    {
