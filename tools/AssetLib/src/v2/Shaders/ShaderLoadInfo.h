...
{
    ShaderRasterizationDynamicStates DynamicStates{ShaderRasterizationDynamicState::None};
    ...
    std::vector<ShaderImageFormat> ColorFormats{};
    std::optional<ShaderImageFormat> DepthFormat{};
